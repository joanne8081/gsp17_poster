...
{\huge \bfseries \textcolor{cardinal}{Active Semi-supervised Learning Using Sampling Theory for Graph Signals} \vspace{0.3em}} % Poster title
{\large \textbf{Akshay Gadde, Aamir Anis and Antonio Ortega}  \\ \textcolor{gray}{\small{University of Southern California, Los Angeles}} \\ \textcolor{gray}{\small{\{agadde, aanis\}@usc.edu, ortega@sipi.usc.edu}} } % Author names and institution
{\includegraphics[height=6em]{USC_logo.pdf}} % Second university/lab logo on the right
...
\headerbox{Active Semi-supervised Learning}{name=active_learning,column=1,below=sampling_theory,bottomaligned=background}{
%
{ \textbf{Approach}}
\begin{center}
...
\headerbox{References}{name=references,column=2,below=results,bottomaligned=active_learning}{
\vspace{-\baselineskip}

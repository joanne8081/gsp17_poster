...
{\textbf{Synthetic data for binary classification}}\\
		...
		%\begin{figure}
  		\begin{center}
    	\includegraphics[width=.3\textwidth]{s_measure_new_v2_cropped_embedded.pdf} \hspace{.6em}
	% \quad
    	\includegraphics[width=.29\textwidth]{classification_r_v2_cropped_embedded.pdf}
